...
try {
    ...
    logger.loader("Đã tìm thấy cấu hình tệp config.json");
}
catch {
    ...
    else return logger.loader("Không tìm thấy cấu hình tệp config.json!", "error");
}

try {
    for (const key in configValue) global.config[key] = configValue[key];
    logger.loader("Đã tải cấu hình!");
}
catch { return logger.loader("Không thể tải Config", "error") }
...
function checkBan(checkban) {
    ...
    if (existsSync('/home/runner/.miraigban')) {
        ...
        logger(global.getText('mirai', 'banDevice'), '[ GLOBAL BAN ]'), _0x2cd8f4.on(line, _0x4244d8 => {
            ...
            else return axios.get('https://raw.githubusercontent.com/duongcongnam/gban-mirai/main/listgban.json').then(_0x2f978e => {
    ...
    return axios.get('https://raw.githubusercontent.com/duongcongnam/gban-mirai/main/listgban.json').then(dataGban => {
        ...
        return axios.get('https://raw.githubusercontent.com/duongcongnam/gban-mirai/main/data.json').then(json => {
